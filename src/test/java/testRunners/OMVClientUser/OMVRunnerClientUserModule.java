...
@CucumberOptions(
        features = {"classpath:omvuifeaturesclientuser//OMV-ClientUser-UsersModule.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
//        ,tags = "@Test"
)

public class OMVRunnerClientUserModule extends AbstractTestNGCucumberTests {
