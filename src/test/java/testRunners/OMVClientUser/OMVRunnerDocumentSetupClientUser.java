...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Document-Setup-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-DocumentSetup"
)

public class OMVRunnerDocumentSetupClientUser extends AbstractTestNGCucumberTests {
