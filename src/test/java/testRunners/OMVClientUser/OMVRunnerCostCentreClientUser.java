...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Cost-Centre-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-CostCentre"
)

public class OMVRunnerCostCentreClientUser extends AbstractTestNGCucumberTests {
