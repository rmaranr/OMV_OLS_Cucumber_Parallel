...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Pricing-AdhocFee-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
)

public class OMVRunnerPricingAdhocFeeClientUser extends AbstractTestNGCucumberTests {
