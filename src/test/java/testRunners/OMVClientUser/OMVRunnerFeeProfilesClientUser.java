...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Pricing-FeeProfile-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
)

public class OMVRunnerFeeProfilesClientUser extends AbstractTestNGCucumberTests {
