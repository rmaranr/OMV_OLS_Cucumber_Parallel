...
@CucumberOptions(
    features = {"src//test//resources//omvuifeatures//OMV-AddPricingGroups-Rebates.feature"}
        , glue = {"stepDefinitionsUI"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
            ,tags = "@Test"
)

public class OMVRunnerClassAddPricingGroupsRebates extends AbstractTestNGCucumberTests {
