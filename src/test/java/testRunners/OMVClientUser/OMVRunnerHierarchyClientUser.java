...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Hierarchy-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-Hierarchies"
)

public class OMVRunnerHierarchyClientUser extends AbstractTestNGCucumberTests {
