...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Group-PIN-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-GroupPin"
)

public class OMVRunnerGroupPINClientUser extends AbstractTestNGCucumberTests {
