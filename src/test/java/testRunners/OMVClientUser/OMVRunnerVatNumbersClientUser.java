...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Vat-Numbers-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-VatNumbers"
)

public class OMVRunnerVatNumbersClientUser extends AbstractTestNGCucumberTests {
