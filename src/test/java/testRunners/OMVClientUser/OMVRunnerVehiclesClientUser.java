...
@CucumberOptions(
        features = {"classpath:omvuifeaturesclientuser//OMV-Vehicles-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
        , plugin = {"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
        , tags = "@UI-Vehicles"
)

public class OMVRunnerVehiclesClientUser extends AbstractTestNGCucumberTests {
