...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Account-Information-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-AccountInformation"
)

public class OMVRunnerAccountInformationClientUser extends AbstractTestNGCucumberTests {
