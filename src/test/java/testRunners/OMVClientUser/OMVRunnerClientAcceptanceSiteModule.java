...
@CucumberOptions(
        features = {"classpath:omvuifeaturesclientuser//OMV-AcceptanceSites.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
//        ,tags = "@Test"
)

public class OMVRunnerClientAcceptanceSiteModule extends AbstractTestNGCucumberTests {
