...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Accounts-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
            ,tags = "@UI-AccountInformation"
)

public class OMVRunnerAccountsModuleClientUser extends AbstractTestNGCucumberTests {
