...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-CardControlProfile-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-CardControlProfile"
)

public class OMVRunnerCardControlProfileClientUser extends AbstractTestNGCucumberTests {
