...
@CucumberOptions(
    features = {"classpath:omvuifeaturesclientuser//OMV-Manage-auto-reissue-ClientUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-ManageAutoReissue"
)

public class OMVRunnerManageAutoReissueClientUser extends AbstractTestNGCucumberTests {
