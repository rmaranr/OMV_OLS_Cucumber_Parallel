...
@CucumberOptions(
        features = {"classpath:omvuifeaturescountryuser//OMV-CountryUser-UsersModule.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
//            ,tags = "@Test"
)

public class OMVRunnerCountryUserModule extends AbstractTestNGCucumberTests {
