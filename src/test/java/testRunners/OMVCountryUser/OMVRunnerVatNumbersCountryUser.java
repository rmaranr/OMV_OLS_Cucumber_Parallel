...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-Vat-Numbers-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
        ,tags="@UI-VatNumbers"
)

public class OMVRunnerVatNumbersCountryUser extends AbstractTestNGCucumberTests {
