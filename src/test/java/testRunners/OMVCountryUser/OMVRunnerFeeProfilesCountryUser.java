...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-Pricing-FeeProfile-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
)

public class OMVRunnerFeeProfilesCountryUser extends AbstractTestNGCucumberTests {
