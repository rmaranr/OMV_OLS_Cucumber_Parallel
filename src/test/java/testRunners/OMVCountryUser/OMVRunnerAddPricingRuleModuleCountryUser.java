...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-AddPricingRules.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
//    ,tags = "@Test"
)

public class OMVRunnerAddPricingRuleModuleCountryUser extends AbstractTestNGCucumberTests {
