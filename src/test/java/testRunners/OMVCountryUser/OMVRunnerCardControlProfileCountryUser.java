...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-CardControlProfile-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-CardControlProfile"
)

public class OMVRunnerCardControlProfileCountryUser extends AbstractTestNGCucumberTests {
