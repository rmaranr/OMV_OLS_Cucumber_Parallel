...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-Document-Setup-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags = "@UI-DocumentSetup"
)

public class OMVRunnerDocumentSetupCountryUser extends AbstractTestNGCucumberTests {
