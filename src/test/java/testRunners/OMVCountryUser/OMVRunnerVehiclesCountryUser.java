...
@CucumberOptions(
        features = {"classpath:omvuifeaturescountryuser//OMV-Vehicles-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
        , plugin = {"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
        , tags = "@UI-Vehicles"
)

public class OMVRunnerVehiclesCountryUser extends AbstractTestNGCucumberTests {
