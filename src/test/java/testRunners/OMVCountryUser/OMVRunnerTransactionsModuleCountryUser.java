...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-TransactionsModule.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    , tags = "@UI-Transactions"
)

public class OMVRunnerTransactionsModuleCountryUser extends AbstractTestNGCucumberTests {
