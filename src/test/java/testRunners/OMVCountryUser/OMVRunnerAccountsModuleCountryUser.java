...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-AccountsModuleCountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
            ,tags = "@UI-AccountInformation"
)

public class OMVRunnerAccountsModuleCountryUser extends AbstractTestNGCucumberTests {
