...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-Account-Information-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-AccountInformation"
)

public class OMVRunnerAccountInformationCountryUser extends AbstractTestNGCucumberTests {
