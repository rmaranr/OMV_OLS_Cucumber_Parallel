...
@CucumberOptions(
        features = {"classpath:omvuifeaturescountryuser//OMV-Financial-Information-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
        , plugin = {"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
        , tags = "@UI-FinancialInformation"
)

public class OMVRunnerFinancialInformationCountryUser extends AbstractTestNGCucumberTests {
