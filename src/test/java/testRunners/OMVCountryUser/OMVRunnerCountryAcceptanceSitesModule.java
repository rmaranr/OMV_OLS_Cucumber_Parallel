...
@CucumberOptions(
        features = {"classpath:omvuifeaturescountryuser//OMV-AcceptanceSites.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
//            ,tags = "@Test"
)

public class OMVRunnerCountryAcceptanceSitesModule extends AbstractTestNGCucumberTests {
