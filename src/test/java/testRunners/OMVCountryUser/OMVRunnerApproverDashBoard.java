...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-ApproverDashboard.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-ApproverDashBoard"
)

public class OMVRunnerApproverDashBoard extends AbstractTestNGCucumberTests {
