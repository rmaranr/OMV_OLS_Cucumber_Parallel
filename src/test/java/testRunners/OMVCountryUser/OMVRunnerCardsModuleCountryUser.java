...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-CardsCountryUser.feature"}
        , glue = {"stepDefinitions/stepDefinitionsUI"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
            ,tags = "@UI-Cards"
)

public class OMVRunnerCardsModuleCountryUser extends AbstractTestNGCucumberTests {
