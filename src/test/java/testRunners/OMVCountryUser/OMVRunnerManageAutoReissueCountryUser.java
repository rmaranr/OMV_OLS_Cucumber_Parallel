...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-Manage-auto-reissue-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
    ,tags="@UI-ManageAutoReissue"
)

public class OMVRunnerManageAutoReissueCountryUser extends AbstractTestNGCucumberTests {
