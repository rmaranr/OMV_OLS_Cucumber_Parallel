...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-AddBonuses.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
//        , tags = "@Test"
)

public class OMVRunnerAddPricingBonusModuleCountryUser extends AbstractTestNGCucumberTests {
