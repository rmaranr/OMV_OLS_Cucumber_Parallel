...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-Pricing-AdhocFee-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
)

public class OMVRunnerPricingAdhocFeeCountryUser extends AbstractTestNGCucumberTests {
