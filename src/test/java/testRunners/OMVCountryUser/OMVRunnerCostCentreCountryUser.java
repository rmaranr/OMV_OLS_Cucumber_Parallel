...
@CucumberOptions(
        features = {"classpath:omvuifeaturescountryuser//OMV-Cost-Centre-CountryUser.feature"}
        , glue = {"stepDefinitions/stepDefinitionsUI"}, monochrome = true
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
        ,tags="@UI-CostCentre"
)

public class OMVRunnerCostCentreCountryUser extends AbstractTestNGCucumberTests {
