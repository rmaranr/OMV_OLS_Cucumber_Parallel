...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-Authorizations.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
//            ,tags = "@Test"
)

public class OMVRunnerAuthorizationsModuleCountryUser extends AbstractTestNGCucumberTests {
