...
@CucumberOptions(
    features = {"classpath:omvuifeaturescountryuser//OMV-Group-PIN-CountryUser.feature"}
        , glue = {"stepDefinitions"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
        ,tags="@UI-GroupPin"
)

public class OMVRunnerGroupPINCountryUser extends AbstractTestNGCucumberTests {
