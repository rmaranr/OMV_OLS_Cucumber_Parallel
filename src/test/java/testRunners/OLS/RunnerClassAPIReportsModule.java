...
@CucumberOptions(features = { "classpath:apifeatures//OLSReportsModule.feature" },
        glue = {"stepDefinitions/stepDefinitionsAPI"}
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}

//, tags = { "@editScheduledReportStatus" }
)

@Test
public class RunnerClassAPIReportsModule extends AbstractTestNGCucumberTests {
