...
@CucumberOptions(features = { "classpath:apifeatures//OLSCustomerContactsModule.feature" },
...
//, tags = { "@CustomerContactsCreateModule" }
//, tags = { "@OLSDeleteCustomerContactDetails" }
//,tags = { "@CustomerContactsUpdatesModule" }
)

@Test
public class RunnerClassAPIContactsModule extends AbstractTestNGCucumberTests {
