...
@CucumberOptions(features = { "classpath:apifeatures//OLSAuthorisationsModule.feature" },
...
@Test
public class RunnerClassAPIAuthorisationsModule extends AbstractTestNGCucumberTests {
