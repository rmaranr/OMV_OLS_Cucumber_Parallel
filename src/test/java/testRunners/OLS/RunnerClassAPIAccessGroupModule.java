...
@CucumberOptions(features = { "classpath:apifeatures//OLSAccessGroupModule.feature" },
        glue = {"stepDefinitions/stepDefinitionsAPI"}
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
)

@Test
public class RunnerClassAPIAccessGroupModule extends AbstractTestNGCucumberTests {
