...
@CucumberOptions(
    features = {"classpath:apifeatures//OLSDataSetup.feature"}
        , glue = {"stepDefinitions/stepDefinitionsAPI"}, monochrome = true
    ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
            ,tags = "@Test"
)

public class RunnerClassTestDataFile extends AbstractTestNGCucumberTests {
