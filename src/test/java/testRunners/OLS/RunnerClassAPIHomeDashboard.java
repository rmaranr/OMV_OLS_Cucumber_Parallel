...
@CucumberOptions(features = { "classpath:apifeatures//OLSHomeDashBoard.feature" },
        glue = {"stepDefinitions/stepDefinitionsAPI"}
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}

//, tags = { "@getTotaltransactions" }
)

@Test
public class RunnerClassAPIHomeDashboard extends AbstractTestNGCucumberTests {
