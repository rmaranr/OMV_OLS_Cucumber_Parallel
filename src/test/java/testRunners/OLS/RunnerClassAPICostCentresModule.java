...
@CucumberOptions(features = { "classpath:apifeatures//OLSCustomerCostCentre.feature" },
...
//, tags = { "@OLSGetCostCentreDetails,@OLSCostCentreCreation" }
//, tags = { "@OLSCostCentreCreation" }
)

@Test
public class RunnerClassAPICostCentresModule extends AbstractTestNGCucumberTests {
