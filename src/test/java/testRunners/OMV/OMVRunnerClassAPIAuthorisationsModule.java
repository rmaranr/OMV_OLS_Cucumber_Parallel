...
@CucumberOptions(features = { "classpath:omvapifeatures//OMVAuthorisationsModule.feature" },
        glue = {"stepDefinitions/stepDefinitionsAPI"}
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}

//, tags = { "@OMVSearchAuthorisations" }

)

@Test
public class OMVRunnerClassAPIAuthorisationsModule extends AbstractTestNGCucumberTests {
