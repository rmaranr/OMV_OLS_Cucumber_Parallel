...
@CucumberOptions(features = { "classpath:omvapifeatures//OMVCardsModule.feature" },
        glue = {"stepDefinitions/stepDefinitionsAPI"}
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}

//, tags = "@SearchCardsForCSR"

)

@Test
public class OMVRunnerClassAPICardsModule extends AbstractTestNGCucumberTests {
