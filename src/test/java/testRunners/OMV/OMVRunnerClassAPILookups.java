...
@CucumberOptions(features = { "classpath:omvapifeatures//OMVLookups.feature" },
        glue = {"stepDefinitions/stepDefinitionsAPI"}
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}

//, tags = "@TransactionSearchLookupForCostCentre"
)

@Test
public class OMVRunnerClassAPILookups extends AbstractTestNGCucumberTests {
