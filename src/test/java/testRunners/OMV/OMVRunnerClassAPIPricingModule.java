...
@CucumberOptions(features = { "classpath:omvapifeatures//OMVPricingModule.feature" },
        glue = {"stepDefinitions/stepDefinitionsAPI"}
        ,plugin={"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
        , tags = "@CSRAddPricingRule"
)

@Test
public class OMVRunnerClassAPIPricingModule extends AbstractTestNGCucumberTests {
