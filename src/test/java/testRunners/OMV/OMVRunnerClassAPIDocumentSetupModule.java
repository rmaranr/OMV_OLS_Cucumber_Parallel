...
@CucumberOptions(features = { "classpath:omvapifeatures//OMVDocumentSetupModule.feature" },
...
@Test
public class OMVRunnerClassAPIDocumentSetupModule extends AbstractTestNGCucumberTests {
