Scenario Outline: OMV 23,359 : Validate the edit Discounts at single level with Discount
...
Then User click three dot icon for a record which contain group as status "Active" in "Discounts" module
And User click three dot icon of "1" record in module "Discounts" based on "BonusName"
...
And User enter "maxValue" as "10" in "Discounts" module having length "2" in "add" form
