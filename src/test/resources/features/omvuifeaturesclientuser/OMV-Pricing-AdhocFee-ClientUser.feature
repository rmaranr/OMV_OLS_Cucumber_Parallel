Feature: Client User Adhoc Fee module scenarios

  Scenario: Client User : OMV-3462 Add adhoc fee using Type as 'Fee'
  ...
  Scenario: Client User : OMV-3462 Add adhoc fee using Type as 'Fee Reversal'
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User verify the logged in user is eligible to create "new" adhoc fee or not
  ...
  Scenario: Client User : OMV-3462 Verify error message when duplicate reference name entered
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
