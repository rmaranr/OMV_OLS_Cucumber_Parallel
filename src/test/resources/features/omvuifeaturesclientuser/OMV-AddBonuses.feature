...
#    And User validate "snackbar-text" message "Bonus has been created" in "Bonuses" module
    Examples:
      ...
      | TC01 : OMV 202,203,204,205,455,418: Validate the creating Bonus at client level configuration before pinning account with discount   | ClientUserName  | ClientPassWord  | Fixed       | Discount  | Discount has been added  | Discount has been updated  | (//mat-radio-button[@ng-reflect-value='Discount']/label/div)[1]  |
#      | TC02 : OMV 202,203,204,205,455,418: Validate the creating Bonus at country level configuration before pinning account with discount  | CountryUserName | CountryPassword | Fixed       | Discount  | Discount has been added  | Discount has been updated  | (//mat-radio-button[@ng-reflect-value='Discount']/label/div)[1]  |
      | TC03 : OMV 202,203,204,205,455,418: Validate the creating Bonus at client level configuration before pinning account with Surcharge  | ClientUserName  | ClientPassWord  | Fixed       | Surcharge | Surcharge has been added | Surcharge has been updated | (//mat-radio-button[@ng-reflect-value='Surcharge']/label/div)[1] |
...
#    And User validate "snackbar-text" message "Day and time restrictions has been added" in "Bonuses" module
...
#    And User click on button contains "Monday 24 hrs" using locator "//div[@class='price-value ng-star-inserted'][1]/div/mat-slide-toggle/label/div" which has locator type "xpath" using method "click"
#    Then User click on button "Update" using span text
#    And User validate "snackbar-text" message "Day and time restrictions has been updated" in "Bonuses" module
...
#    And User validate "snackbar-text" message "Bonus has been created" in "Bonuses" module
    Examples:
      | Scenario | UserName | PassWord | valueMethod | category | AddCategoryMessage | UpdateCategoryMessage | categoryLocator |
      | TC15 : OMV 202,203,204,205,455,418: Validate the creating Bonus at client level configuration after pinning account with discount | ClientUserName | ClientPassWord | Fixed       | Discount | Discount has been added | Discount has been updated |(//mat-radio-button[@ng-reflect-value='Discount']/label/div)[1]|
