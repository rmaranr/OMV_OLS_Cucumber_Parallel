Feature: UI:ClientUser - Vat number scenarios from Accounts Module
  ################### Vat Numbers #########################
  @UI-VatNumbers @Test
...
#    Then User verify in the database newly created Vat number has been added
  ...
  @UI-VatNumbers
  Scenario: TC-01 : Client User : OMV-1025 User validate the "PRIMARY TAX NUMBER" and "Client SPECIFIC TAX NUMBER" sections are not present where there is no tax numbers at account and Client level
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
  ...
  @UI-VatNumbers
  Scenario: TC-02 : Client User : OMV-1025 User validate the default and expanded field values of "Client SPECIFIC TAX NUMBERS" and "PRIMARY TAX NUMBER" section not present when there is no tax number at account level
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    ...
    When User click on the "menu" "Admin"
    And User click on the "Submenu" "VAT numbers"
    And User validate "default" section of tax numbers module for "Client SPECIFIC TAX NUMBER" for record which is at position "1"
    And User validate "Expanded" section of tax numbers module for "Client SPECIFIC TAX NUMBER" for record which is at position "1"

  @UI-VatNumbers
  Scenario: TC-03 : Client User : OMV-1025 User validate "Client SPECIFIC TAX NUMBER" section not present when there is no tax number at Client level and validate default and expanded field values of "PRIMARY TAX NUMBERS"
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
  ...
  @UI-VatNumbers
  Scenario: TC-04 : Client User : OMV-1025 User validate the default and expanded field values of "PRIMARY TAX NUMBERS" and "Client SPECIFIC TAX NUMBER" sections
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    ...
    When User click on the "menu" "Admin"
    And User click on the "Submenu" "VAT numbers"
    And User validate "default" section of tax numbers module for "Client SPECIFIC TAX NUMBER" for record which is at position "2"
    And User validate "Expanded" section of tax numbers module for "Client SPECIFIC TAX NUMBER" for record which is at position "2"
    Then User expand the record based on number "2"
    And User validate "default" section of tax numbers module for "PRIMARY TAX NUMBER" for record which is at position "1"
    And User validate "Expanded" section of tax numbers module for "PRIMARY TAX NUMBER" for record which is at position "1"

  @UI-VatNumbers
  Scenario: TC-01 : Client User : OMV-1028 Validate user is able to navigate Vat Numbers module page after clicking 'Cancel' button on 'New Vat Numbers' page
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
  ...
  Scenario: TC-01 : Client User : OMV-2030 User validate Decline flow on the system date for expire vat number
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    ...
    Then User validate newly "updated" vat number record "present" in "staging" table with approval status as "Pending"
    ...
    Then User validate newly "updated" vat number record "present" in "staging" table with approval status as "Declined"
    Then User validate newly "updated" vat number record "notPresent" in "main" table with approval status as "NA"

  Scenario: TC-02 : Client User : OMV-2030 User validate Decline flow on the future date for expire vat number
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
  ...
  Scenario: TC-03 : Client User : OMV-2030 User validate Approve flow on the system date for expire vat number
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account for which should not have pending vat number status for "systemDate"
    ...
    Then User validate newly "updated" vat number record "present" in "staging" table with approval status as "Approved"
    Then User validate newly "updated" vat number record "Present" in "main" table with approval status as "NA"

  Scenario: TC-04 : Client User : OMV-2030 User validate Approve flow on the future date for expire vat number
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account for which should not have pending vat number status for "futureDate"
  ...
  Scenario: TC01: Client User :OMV-2030 Validate Decline flow on the system date for newly created vat number
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account for which should not have pending vat number status for "systemDate"
    ...
    And User click on "Submit" based on tag name "span"
    And User validate message "VAT number has been created" based on tag name "div"
    Then User validate newly "created" vat number record "present" in "staging" table with approval status as "Pending"
    And User "Decline" the vat number which has been recently "Created"
    And User validate message "VAT number has been declined" based on tag name "div"
    Then User validate newly "created" vat number record "present" in "staging" table with approval status as "Declined"
    Then User validate newly "created" vat number record "notPresent" in "main" table with approval status as "NA"

  Scenario: TC02:  Client User :OMV-2030 Validate Decline flow on the future date for newly created vat number
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account for which should not have pending vat number status for "futureDate"
  ...
  Scenario: TC03:  Client User :OMV-2030 Validate Approve flow on the system date for newly created vat number
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account for which should not have pending vat number status for "systemDate"
    ...
    And User validate message "VAT number has been Approved" based on tag name "div"
    Then User validate newly "created" vat number record "present" in "staging" table with approval status as "Approved"
    Then User validate newly "created" vat number record "present" in "main" table with approval status as "NA"

  Scenario: TC04:  Client User :OMV-2030 Validate Approve flow on the future date for newly created vat number
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account for which should not have pending vat number status for "futureDate"
