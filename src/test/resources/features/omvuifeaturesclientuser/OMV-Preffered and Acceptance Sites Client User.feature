Feature: Preferred sites and Acceptance sites functionality will be available in the feature
  ...
  Scenario Outline: OMV 216 : Validate the search of the preferred sites
    ...
    Examples:
      ...
      | TC01 : OMV 216: Validate the search of the preferred sites at client level configuration after pinning account    | ClientUserName  | ClientPassWord  | accountName              | text                       |
  ...
  Scenario Outline: OMV 216 : Validate the sort functionality of preferred sites
    ...
    Examples:
      | Scenario                                                                                                                 | UserName        | PassWord        | fieldNameOfAccountSearch | accountSearchFieldBehavior |
      | TC03 : OMV 216: Validate the sort functionality of preferred sites at client level configuration after pinning account   | ClientUserName  | ClientPassWord  | accountName              | text                       |
  ...
  Scenario Outline: OMV 299 : Validate the export functionality of preferred sites
    ...
    Examples:
      | Scenario                                                                                                                   | UserName        | PassWord        | fieldNameOfAccountSearch | accountSearchFieldBehavior |
      | TC01 : OMV 299: Validate the export functionality of preferred sites at client level configuration after pinning account   | ClientUserName  | ClientPassWord  | accountName              | text                       |
  ...
  Scenario Outline: OMV 299 : Validate the remove site functionality of preferred sites
    ...
    Examples:
      | Scenario                                                                                                                        | UserName        | PassWord        | fieldNameOfAccountSearch | accountSearchFieldBehavior |
      | TC03 : OMV 299: Validate the remove site functionality of preferred sites at client level configuration after pinning account   | ClientUserName  | ClientPassWord  | accountName              | text                       |
  ...
  Scenario Outline: OMV 217 : Validate the Add site functionality of preferred sites
    ...
    Examples:
      ...
      | TC01 : OMV 217: Validate the Add site functionality of preferred sites at client level configuration after pinning account   | ClientUserName  | ClientPassWord  | accountName              | text                       | country                   | dropDown                    |

    ######################################################################  Acceptance Sites test cases #################3Feature:
  @Test
  Scenario Outline: OMV 903 : Validate the search of the Acceptance sites for client User
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    When User enter "<UserName>" and "<PassWord>"
    And User click on login button
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    ...
    Examples:
      | Scenario                                                                                                          | UserName        | PassWord        | fieldNameOfAccountSearch | accountSearchFieldBehavior |
      | TC01 : OMV 903: Validate the search of the Acceptance sites at client level configuration after pinning account    | ClientUserName  | ClientPassWord  | accountName              | text                       |

  @Test
  Scenario Outline: OMV 903 : Validate the sort functionality of Acceptance sites for client user
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    When User enter "<UserName>" and "<PassWord>"
    And User click on login button
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    ...
    Examples:
      | Scenario                                                                                                                 | UserName        | PassWord        | fieldNameOfAccountSearch | accountSearchFieldBehavior |
      | TC03 : OMV 903: Validate the sort functionality of Acceptance sites at client level configuration after pinning account   | ClientUserName  | ClientPassWord  | accountName              | text                       |


  @Test
  Scenario Outline: OMV 903 : Validate the export functionality of Acceptance sites for Client User
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    When User enter "<UserName>" and "<PassWord>"
    And User click on login button
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    ...
    Examples:
      | Scenario                                                                                                                   | UserName        | PassWord        | fieldNameOfAccountSearch | accountSearchFieldBehavior |
      | TC01 : OMV 903: Validate the export functionality of Acceptance sites at client level configuration after pinning account   | ClientUserName  | ClientPassWord  | accountName              | text                       |

  @Test
  Scenario Outline: OMV 903 : Validate the remove site functionality of Acceptance sites for Client User
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    When User enter "<UserName>" and "<PassWord>"
    And User click on login button
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    ...
    Examples:
      | Scenario                                                                                                                        | UserName        | PassWord        | fieldNameOfAccountSearch | accountSearchFieldBehavior |
      | TC03 : OMV 903: Validate the remove site functionality of Acceptance sites at client level configuration after pinning account   | ClientUserName  | ClientPassWord  | accountName              | text                       |


  @Test
  Scenario Outline: OMV 905 : Validate the Add site functionality of Acceptance sites for Client User
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    When User enter "<UserName>" and "<PassWord>"
    And User click on login button
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    ...
    Examples:
      ...
      | TC01 : OMV 905: Validate the Add site functionality of Acceptance sites at client level configuration after pinning account   | ClientUserName  | ClientPassWord  | accountName              | text                       | country                   | dropDown                    |
