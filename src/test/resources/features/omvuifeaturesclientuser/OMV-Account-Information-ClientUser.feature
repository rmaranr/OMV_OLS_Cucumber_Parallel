Feature: UI:ClientUser - Account Information scenarios from Accounts module
   ################ must be able to view additional account related information in the account details ##############
  @UI-AccountInformation
  Scenario: TC01: Client User : OMV-1007 : User must be able to edit 'PRICING CONTROL VALUES' information for Client User
    ...
    And User enter account number in corresponding field which "has", "1 - Active" status and "Active" based on logged in user "csrClientUser"
  ...
  @UI-AccountInformation
  Scenario: TC-01 : Client User : OMV-1402 Validate user must be able to view additional account related information in the account details for Client User
    ...
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    And User select client and country based on logged in user "ClientUserName"
    And User enter account number in corresponding field which "has", "Active" status and "Active" based on logged in user "csrClientUser"
    And User click on "Search" button
    And User click three dot icon of "1" record in module "accounts" based on "accountName"
    Then User click on button "Select account"
    And User validate message "Account information" based on tag name "div"
    ...
    Then User verify based on validation control user should be able to "View" fields then validate in database for section "CUSTOMER DETAILS" for user "CSR"
  ...
  @UI-AccountInformation
  Scenario: TC01: Client User : OMV-1005 : User must be able to edit 'Account Details' information for Client User
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User select client and country based on logged in user "ClientUserName"
    And User make sure account is not pinned for logged in user
    ...
    And User validate button "+ New" status "disabled" using tag name "mav-button", attribute name "ng-reflect-klass", attribute value "add-button" and get status of button using attribute "ng-reflect-disabled"
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    And User enter account number in corresponding field which "has", "" status and "" based on logged in user "csrClientUser"
    And User click on "Search" button
    And User click three dot icon of "1" record in module "accounts" based on "accountName"
    Then User click on button "Select account"
    And User validate message "Account information" based on tag name "div"
  ...
  @UI-AccountInformation
  Scenario: TC01: Client User : OMV-1007 : User must be able to edit 'ADDITIONAL DETAILS' information for Client User
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User select client and country based on logged in user "ClientUserName"
    When User click on the "menu" "Cards"
  ...
  @UI-AccountInformation
  Scenario: TC01: Client User : OMV-1007 : User must be able to edit 'AUTHENTICATION' information for Client User
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User select client and country based on logged in user "ClientUserName"
    When User click on the "menu" "Cards"
  ...
  Scenario: TC01: Client User : OMV-1006 : User must be able to edit 'Application details' information for Client User
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User select client and country based on logged in user "ClientUserName"
    And User make sure account is not pinned for logged in user
  ...
  @UI-AccountInformation
  Scenario Outline: TC01 : Client User : OMV-1003 Validate user is able to edit 'Account summary' details and approve them
  ...
  Scenario: TC01 : Client User : OMV-1004 Validate user is able to view approved upates in 'view updates' pop up of 'Account summary' details section
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
  ...
  Scenario: TC-01 : Client User : OMV-1009 Validate edit functionality of Authentication details section in 'Account information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  Scenario: TC-01 : Client User : OMV-2030 Validate Mailing City and Mailing street are populating as expected after declining the request also
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    When User click on the "menu" "Cards"
  ...
  Scenario: TC-02 : Client User : OMV-2030 Validate Approve flow for effective date as Processing date after updating fields only part of approval flow
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    When User click on the "menu" "Cards"
  ...
  Scenario: TC-03 : Client User : OMV-2030 Validate Approve flow for effective date as future than Processing date after updating fields only part of approval flow
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    When User click on the "menu" "Cards"
  ...
  Scenario: TC-04 : Client User : OMV-2030 Validate Approve flow for effective date as Processing date after updating fields which are included and not included in approval flow
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    When User click on the "menu" "Cards"
  ...
  Scenario: TC-05 : Client User : OMV-2030 Validate Approve flow for effective date as future than Processing date after updating fields which are included and not included in approval flow
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    When User click on the "menu" "Cards"
  ...
  Scenario: TC-06 : Client User : OMV-2030 Validate Not Included in Approval flow fields are populating as expeted before approving request and after approving request physical and mailing address should be same and check box should be checked in edit account summary pop up
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    When User click on the "menu" "Cards"
