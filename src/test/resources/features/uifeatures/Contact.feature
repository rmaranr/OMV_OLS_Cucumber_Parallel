Feature: OLS User : Contact Scenarios
...
#    And User verifies the "Save" button is disabled using locator "button"
    ...
    And User enter "emailAddress" as "srilatha.nerella@wexinc.com" in module "contacts" having length "10" in "Edit" form
...
#    And User verifies the "Save" button is disabled using locator "button"
    And User enter "addressLine" as "5919Trussville" in module "contacts" having length "90" in "Edit" form
    And User enter "suburb" as "Birmingham" in module "contacts" having length "90" in "Edit" form
