Feature: UI:CountryUser - Accounts selection scenarios
  ...
  Scenario: Search an account using invalid account number then clear search results validate country drop down is populated correctly
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    ...
    And User select client and country based on logged in user "CountryUserName"
    When User validate expected value "Country" from property file "Yes" actual value from locator "mav-select[ng-reflect-name='country']>mat-select" which has locator type "cssSelector" get value using attribute "ng-reflect-model"
  ...
  @UI-AccountInformation
  Scenario: OMV-10: Validate the menu and sub menu highlighting
    And User click on the "menu" "Pricing"
    And User click on the "submenu" "Discounts"
  ...
  @UI-AccountInformation
  Scenario: OMV 43: Validate the change context from the context picker when user entitled to more than once account, change account in context picker, Validate the Return to customer care in context picker
    Then User select "Select account" option using tag name "div" from context picker if logged in user "CountryUserName" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
    And User click on "Search" button
...
#    And  User verifies whether the "Return to customer care" option is available
  ...
  @UI-AccountInformation
  Scenario: OMV 43: Validate the select account in context picker
    Then User click on "Select account" based on tag name "div"
    And  Verify the presence of the page header "Accounts"

  @UI-AccountInformation
  Scenario: OMV 43: Validate the Return to customer care in context picker
    Then User select "Select account" option using tag name "div" from context picker if logged in user "CountryUserName" has access to more than one customer
  ...
  @UI-AccountInformation
  Scenario: TC-01 : Country User : OMV-1761 Validate warning message is displayed when an account is pinned which is not in active status
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    ...
    ##Search scenarios
  @UI-AccountInformation
  Scenario Outline: OMV-45 User validate "Search By" message in Pre-Search functionality
    ...
    Examples:
      ...
      | TC02 : OMV-45 User validate "Search By" message in Pre-Search functionality for country user | CountryUserName | CountryPassword |

  @UI-AccountInformation
  Scenario Outline: OMV-45 User validate Pre-Search functionality
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
    ...
    Examples:
      ...
      | TC04 : OMV-45 User validate Pre-Search functionality for country user | CountryUserName | CountryPassword | enabled        | search-bar-button |

  @UI-AccountInformation
  Scenario Outline: OMV-45 User validate Search functionality
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
    ...
    Examples:
      | Scenario                                                          | UserName        | PassWord        |
      | TC06 : OMV-45 User validate Search functionality for country user | CountryUserName | CountryPassword |

  @UI-AccountInformation
  Scenario Outline: OMV-45 User validate Post-Search functionality
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
    ...
    Examples:
      | Scenario                                                               | UserName        | PassWord        |
      | TC08 : OMV-45 User validate Post-Search functionality for country user | CountryUserName | CountryPassword |
...
#    Examples:
#      | Scenario                                                                                    | UserName        | PassWord        |
#      | TC10 : OMV-45 Export search results data and validate all data is exported for country user | CountryUserName | CountryPassword |

  @UI-AccountInformation
  Scenario Outline: OMV-44 User search and switch to Account module from Context using "select account" for client and country level accesses
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    ...
    #Client level login to select account
      | TC05: OMV-44 : Country user pin the account by searching accounts using accountName   | CountryUserName | CountryPassword | accountName              | text                       |
      | TC06: OMV-44 : Country user pin the account by searching accounts using accountNumber | CountryUserName | CountryPassword | accountNumber            | text                       |
      | TC08: OMV-44 : Country user pin the account by searching accounts using cardNumber    | CountryUserName | CountryPassword | cardNumber               | text                       |


  Scenario: Country User : OMV-2257 :Validate 'Home' should be hielighted when user logged in to the application and clicked on 'change account' button
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    Then User select "Select account" option using tag name "div" from context picker if logged in user "CountryUserName" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
