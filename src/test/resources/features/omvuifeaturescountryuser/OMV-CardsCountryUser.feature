Feature: UI:CountryUser - Cards module

  @UI-Cards
  Scenario: OMV-885 User validate search criteria should be retained in cards module
    ...
    Then User get account number which "has" records for "cards" module
    ...
    #######################################  Default and Expanded view validation of newly ordered card ####################
  @UI-Cards
  Scenario Outline: OMV-780,781,782,783 : Validate Default and Expanded section field values in Cards module with out pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    When User get an account which is having "cards" records based on user type "OMV"
    And User click on button "Home" using span text
    And User select client and country based on logged in user "CountryUserName"
...
#    Then User validate based on the search criteria the record count displayed in module "Cards" or not for field "<fieldNameOfCardsearch>" based on field value
    ...
    And User validate "Additional Details" omv section field values "costCentre,externalReference,vehicleDescription,licensePlate" with database based on searched field "<fieldNameOfCardsearch>" based on user "<UserName>"
...
#    And User validate "DeliveryAddress" omv section field values "cardAddress,pinAddress,mailIndicator" with database based on searched field "<fieldNameOfCardsearch>" based on user "<UserName>"
    ...
    Examples:
      ...
      | TC-08 : OMV-780,781,782,772,784 : Validate Cards Default and Expanded section field values with out pinning an account by logging in using csrCountry and search using Customernumber | CountryUserName | customerNumber        | text                    |
      | TC-09 : OMV-780,781,782 : Validate Cards Default and Expanded section field values with out pinning an account by logging in using csrCountry and search using IssuingCountry         | CountryUserName | issuingCountry        | text                    |
      | TC-10 : OMV-780,781,782 : Validate Cards Default and Expanded section field values with out pinning an account by logging in using csrCountry and search using Drivername             | CountryUserName | driverName            | text                    |
      | TC-11 : OMV-780,781,782 : Validate Cards Default and Expanded section field values with out pinning an account by logging in using csrCountry and search using Licenseplate           | CountryUserName | licensePlate          | text                    |
      | TC-12 : OMV-780,781,782 : Validate Cards Default and Expanded section field values with out pinning an account by logging in using csrCountry and search using Costcentr              | CountryUserName | costCentreCode        | text                    |
      | TC-13 : OMV-780,781,782 : Validate Cards Default and Expanded section field values with out pinning an account by logging in using csrCountry and search using status                 | CountryUserName | status                | text                    |
      | TC-14 : OMV-780,781,782 : Validate Cards Default and Expanded section field values with out pinning an account by logging in using csrCountry and search using Cardnumber             | CountryUserName | cardNumber            | text                    |

  @UI-Cards
  Scenario Outline: OMV-780,781,782,784,772 : Validate Default and Expanded section field values in Cards module after pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User select client and country based on logged in user "CountryUserName"
    Then User get latest cardNo based on accountNo "accountNumberInCardsModule"
...
#    And User validate "DeliveryAddress" omv section field values "cardAddress,pinAddress,mailIndicator" with database based on searched field "<fieldNameOfCardsearch>" based on user "<UserName>"
    ...
    Examples:
      | Scenario                                                                                                                                                                   | UserName        | fieldNameOfCardsearch | CardsearchFieldBehavior |
      | TC-08 : OMV-780,781,782 : Validate Cards Default and Expanded section field values after pinning an account by logging in using csrCountry and search using Customernumber | CountryUserName | customerNumber        | text                    |
      | TC-09 : OMV-780,781,782 : Validate Cards Default and Expanded section field values after pinning an account by logging in using csrCountry and search using IssuingCountry | CountryUserName | issuingCountry        | text                    |
      | TC-10 : OMV-780,781,782 : Validate Cards Default and Expanded section field values after pinning an account by logging in using csrCountry and search using Drivername     | CountryUserName | driverName            | text                    |
      | TC-11 : OMV-780,781,782 : Validate Cards Default and Expanded section field values after pinning an account by logging in using csrCountry and search using Licenseplate   | CountryUserName | licensePlate          | text                    |
      | TC-12 : OMV-780,781,782 : Validate Cards Default and Expanded section field values after pinning an account by logging in using csrCountry and search using Costcentre     | CountryUserName | costCentreCode        | text                    |
      | TC-13 : OMV-780,781,782 : Validate Cards Default and Expanded section field values after pinning an account by logging in using csrCountry and search using status         | CountryUserName | status                | text                    |
      | TC-14 : OMV-780,781,782 : Validate Cards Default and Expanded section field values after pinning an account by logging in using csrCountry and search using Cardnumber     | CountryUserName | cardNumber            | text                    |

  @UI-Cards
  Scenario: OMV-864 Validate New button status before pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    When User click on the "menu" "Cards"
    ...
    When User click on the "menu" "Cards"
    And User click button "Cards" using tag name "span", attribute name "ng-reflect-marquee-text_", attribute value "Cards" based on position "2"
    Then User verify button "+ New" status "enabled" using tag name "span"
    And User make sure account is not pinned for logged in user
    When User click on the "menu" "Cards"
    And User click button "Cards" using tag name "span", attribute name "ng-reflect-marquee-text_", attribute value "Cards" based on position "2"
    Then User validate button "+ New" status "disabled" using tag name "mav-button", attribute name "ng-reflect-klass", attribute value "add-button" and get status of button using attribute "ng-reflect-disabled"
  ...
  @UI-Cards
  Scenario Outline: TC-01 : OMV-864,872,873,1091,1188 Country User : Order a card using self select identification method
    When User clear property file "TestDataProperties"
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    Then User get an account number which is eligible to order or edit a card based on "<cardReissueTypeCID>" and "<identificationMethod>" for form "add" as user "OMV"
    And User make sure account is not pinned for logged in user
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
    And User select or enter field value "accountNumberInCardsModule" for a field "accountNumber" based on its behavior "text" from "properties"
...
#    Then User validate all stepper values in Review page in form "add"
    ...
    Examples:
      ...
      | TC01 : OMV-864,872,873,1188,1091 Country User Order a card which should be able to reissue with different card no with private card control profile              | CountryUserName | system               | existing                   | private                  | reIssueWithDiffCardNo | Yes                        | onlyLocationCategory        | 5903               | Monday,Tuesday          |
#      | TC02 : OMV-864,872,873,1188,1091 Country User Order a card which should be able to reissue with same card no with existing card control profile                  | CountryUserName | group                | existing                   | private                  | reIssueWithSameCardNo | Yes                        | bothValues                  | 5902               | Wednesday,Thursday      |
#      | TC03 : OMV-864,872,873,1188,1091 Country User Order a card with "Existing default profile"                                                                       | CountryUserName | system               | existing                   | private                  | 1                     | Yes                        | onlyLocationCategory        | 5901               | Friday,Saturday,Sunday  |
#      | TC04 : OMV-864,872,873,1188,1091 Country User Order a card with "Existing private profile"                                                                       | CountryUserName | group                | private                    | private                  | 2                     | Yes                        | noLocationRestriction       | 5901               | Monday,Tuesday,Friday   |
#      | TC05 : OMV-864,872,873,1188,1091 Country User Order a card with identification method "Self select pin" and "Existing profile" for new card control profile      | CountryUserName | system               | newPOSPrompts              | private                  | 3                     | Yes                        | bothValues                  | 5902               | Tuesday,Saturday        |
#      | TC06 : OMV-864,872,873,1188,1091 Country User Order a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | group                | newProductSelection        | private                  | 4                     | Yes                        | onlyLocationCategory        | 5901               | Wednesday,Sunday        |
#      | TC07 : OMV-864,872,873,1188,1091 Country User Order a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | system               | newVelocityLimitSelection  | private                  | 5                     | Yes                        | noLocationRestriction       | 5901               | Monday,Thursday,Sunday  |
#      | TC08 : OMV-864,872,873,1188,1091 Country User Order a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | group                | newLocationRestriction     | private                  | 6                     | Yes                        | bothValues                  | 5902               | Tuesday,Friday,Saturday |
#      | TC09 : OMV-864,872,873,1188,1091 Country User Order a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | system               | newTimeLimits              | private                  | 6                     | Yes                        | bothValues                  | 5903               | Friday,Sunday           |

    @UI-Cards
  Scenario Outline: OMV-888 Country User : Clone a selected card
    When User clear property file "TestDataProperties"
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
    And User set property "actionOfCardControlProfile" value as "<actionOfCardControlPopUp>" in "TestDataProperties"
    Then User get an account number which is eligible to order or edit a card based on "<cardReissueTypeCID>" and "<identificationMethod>" for form "clone" as user "OMV"
    And User select or enter field value "accountNumberInCardsModule" for a field "accountNumber" based on its behavior "text" from "properties"
    And User click on "Search" button
    And User click three dot icon of "1" record in module "accounts" based on "accountName"
    Then User click on button "Select account"
...
#    Then User validate all stepper values in Review page in form "clone"
    ...
    Examples:
      | Scenario                                                                                                                                      | UserName       | identificationMethod | cardControlRadiobuttonName | actionOfCardControlPopUp | noOfCard              | isAlternateAddressRequired | locationRestrictionScenario | cardReissueTypeCID | timeLimits              |
      | TC01 : OMV-888 Country User Clone a card with identification method "Self select pin" and "Existing profile" for new card control profile      | CountryUserName | opposite             | existing                   | newPrivate               | reIssueWithDiffCardNo | Yes                        | bothValues                  | 5901               | Wednesday,Thursday      |
#      | TC02 : OMV-888 Country User Clone a card which should be able to reissue with different card no with private card control profile              | CountryUserName | opposite             | existing                   | private                  | reIssueWithDiffCardNo | Yes                        | onlyLocationCategory        | 5903               | Monday,Tuesday          |
#      | TC03 : OMV-888 Country User Clone a card which should be able to reissue with same card no with existing card control profile                  | CountryUserName | opposite             | existing                   | newPrivate               | reIssueWithSameCardNo | Yes                        | bothValues                  | 5902               | Wednesday,Thursday      |
#      | TC04 : OMV-888 Country User Clone a card with "Existing default profile"                                                                       | CountryUserName | opposite             | existing                   | private                  | 1                     | Yes                        | onlyLocationCategory        | 5901               | Friday,Saturday,Sunday  |
#      | TC05 : OMV-888 Country User Clone a card with "Existing private profile"                                                                       | CountryUserName | opposite             | private                    | private                  | 2                     | Yes                        | noLocationRestriction       | 5901               | Monday,Tuesday,Friday   |
#      | TC06 : OMV-888 Country User Clone a card with identification method "Self select pin" and "Existing profile" for new card control profile      | CountryUserName | noChange             | newPOSPrompts              | private                  | 3                     | Yes                        | bothValues                  | 5902               | Tuesday,Saturday        |
#      | TC07 : OMV-888 Country User Clone a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | noChange             | newProductSelection        | private                  | 4                     | Yes                        | onlyLocationCategory        | 5901               | Wednesday,Sunday        |
#      | TC08 : OMV-888 Country User Clone a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | noChange             | newVelocityLimitSelection  | private                  | 5                     | Yes                        | noLocationRestriction       | 5901               | Monday,Thursday,Sunday  |
#      | TC09 : OMV-888 Country User Clone a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | opposite             | newLocationRestriction     | private                  | 6                     | Yes                        | bothValues                  | 5902               | Tuesday,Friday,Saturday |
#      | TC10 : OMV-888 Country User Clone a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | noChange             | newTimeLimits              | private                  | 6                     | Yes                        | bothValues                  | 5903               | Friday,Sunday           |

  @UI-Cards
  Scenario Outline: OMV-886 Country User : Edit a selected card
    When User clear property file "TestDataProperties"
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    ...
    And User select client and country based on logged in user "CountryUserName"
    And User set property "actionOfCardControlProfile" value as "<actionOfCardControlPopUp>" in "TestDataProperties"
    Then User get an account number which is eligible to order or edit a card based on "<cardReissueTypeCID>" and "<identificationMethod>" for form "edit" as user "OMV"
    And User select or enter field value "accountNumberInCardsModule" for a field "accountNumber" based on its behavior "text" from "properties"
    And User click on "Search" button
    And User click three dot icon of "1" record in module "accounts" based on "accountName"
    Then User click on button "Select account"
...
#    Then User validate success message of "editCard" for no of card "<noOfCard>"
    ...
    Examples:
      ...
      | TC01 : OMV-886 Country User Edit a card with identification method "Self select pin" and "Existing profile" for new card control profile      | CountryUserName | group                | existing                   | existing                 | reIssueWithDiffCardNo | onlyLocationCategory        | 5903               | Monday,Tuesday          |
#      | TC02 : OMV-888 Country User Edit a card which should be able to reissue with different card no with private card control profile              | CountryUserName | opposite             | existing                   | private                  | reIssueWithDiffCardNo | onlyLocationCategory        | 5903               | Monday,Tuesday          |
#      | TC03 : OMV-888 Country User Edit a card which should be able to reissue with same card no with existing card control profile                  | CountryUserName | opposite             | existing                   | newPrivate               | reIssueWithSameCardNo | bothValues                  | 5902               | Wednesday,Thursday      |
#      | TC04 : OMV-888 Country User Edit a card with "Existing default profile"                                                                       | CountryUserName | opposite             | existing                   | private                  | 1                     | onlyLocationCategory        | 5901               | Friday,Saturday,Sunday  |
#      | TC05 : OMV-888 Country User Edit a card with "Existing private profile"                                                                       | CountryUserName | opposite             | private                    | private                  | 2                     | noLocationRestriction       | 5901               | Monday,Tuesday,Friday   |
#      | TC06 : OMV-888 Country User Edit a card with identification method "Self select pin" and "Existing profile" for new card control profile      | CountryUserName | noChange             | newPOSPrompts              | private                  | 3                     | bothValues                  | 5902               | Tuesday,Saturday        |
#      | TC07 : OMV-888 Country User Edit a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | noChange             | newProductSelection        | private                  | 4                     | onlyLocationCategory        | 5901               | Wednesday,Sunday        |
#      | TC08 : OMV-888 Country User Edit a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | noChange             | newVelocityLimitSelection  | private                  | 5                     | noLocationRestriction       | 5901               | Monday,Thursday,Sunday  |
#      | TC09 : OMV-888 Country User Edit a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | opposite             | newLocationRestriction     | private                  | 6                     | bothValues                  | 5902               | Tuesday,Friday,Saturday |
#      | TC10 : OMV-888 Country User Edit a card with identification method "System generated pin" and "Existing profile" for new card control profile | CountryUserName | noChange             | newTimeLimits              | private                  | 6                     | bothValues                  | 5903               | Friday,Sunday           |

  #Then User click drop down "siteGroups" then select value "Random" using tag "mat-select" and attribute "ng-reflect-name"
  #    And User click on body of the webPage to come out of multiselect dropdown
  #    And  User click on "+Add" based on tag name "div"
  #    Then User click drop down "town" then select value "Random" using tag "mat-select" and attribute "ng-reflect-name"
  #    And User click on body of the webPage to come out of multiselect dropdown
  #    Then User click on "Search" based on tag name "span"
  #    And User select first check box from the search results
...
##Validate Export cards for CSR and Single account level
  ...
  @UI-Cards
  Scenario: OMV-771 : Country User - Validate when user enter value in cardNumber and press tab then verify remaining field value are populated based on searched cardNumber
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
#    Then User change card status to active for few cards to perform card actions
    And User click on button "Home" using span text
    And User select client and country based on logged in user "CountryUserName"
    When User click on the "menu" "Cards"
  ...
  @UI-Cards
  Scenario: TC-10 : Validate "No results found,Please update your search keywords." after searching using invalid field value
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User select client and country based on logged in user "CountryUserName"
    And User make sure account is not pinned for logged in user
  ...
  @UI-Cards @Test
  Scenario Outline: OMV-882 : Validate User is able to submit Replace card request after pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    ...
    And User click three dot icon of "1" record in module "accounts" based on "accountName"
    Then User click on button "Select account"
    And User set accountNumber value is property file like "accountNumberInCardsModule" in Transactions module
...
#    Then User get card number for which action applicable "Yes" and action type "ReplaceCard"
  ...
  @UI-Cards
  Scenario: OMV-882 : Validate Error messages in Replace card page after submitting the request after pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User skip this scenario if card is not available to perform replaceCard scenario
  ...
  @UI-Cards
  Scenario: OMV-882 : Validate Primary address and enter alternate address in Replace card functionality after pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User skip this scenario if card is not available to perform replaceCard scenario
...
#  @UI-Cards
#  Scenario: OMV-874 Validate Change PIN positive flow for Country User after pinning an account
#    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
#    And User click on button "Home" using span text
#    And User make sure account is not pinned for logged in user
...
#    ##Done
#  @UI-Cards
#  Scenario: OMV-874 Validate Change PIN Negative flow for Country User after pinning an account
#    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
#    And User click on button "Home" using span text
#    And User make sure account is not pinned for logged in user
#    Then User get card number for which action applicable "Yes" and action type "changePinTypeWishPin"
...
#    Then User validate presence of "t match" field with "mat-error" tag
  ...
  @UI-Cards
  Scenario: OMV-878 ReIssue pin after pinning account for Country User after pinning account
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
...
#    And User validate specific address section "Primary account address:"
  ...
  Scenario: OMV-880 Card Usage after pinning account for Country User after pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User select "Select account" option using tag name "div" from context picker if logged in user "CountryUserName" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
    Then User validate header of module "Accounts"
    And User select or enter value from a field "accountName" based on its behavior "text" for user CountryUserName" in module "accounts"
    And User click on "Search" button
    And User click three dot icon of "1" record in module "accounts" based on "accountName"
    Then User click on button "Select account"
  ...
  Scenario: OMV-890 Validate in Change pin type action select system generated option for Country User after pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get card number for which action applicable "Yes" and action type "changePinTypeWishPin"
...
#    And User validate specific address section "Primary account address:"
  ...
  Scenario: OMV-890 Validate in Change pin type action select self select pin option after pinning account for Country User after pinning an account
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
...
#    And User validate specific address section "Primary account address:"
  ...
  @UI-Cards
  Scenario: TC-01 : OMV-877 : Validate Reset PIN functionality after pinning account for country user
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
...
#    And User validate specific address section "Primary account address:"
  ...
  @UI-Cards
  Scenario: TC-02 : OMV-881 : Validate User is able to change the card status after pinning account for country user
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get card number for which action applicable "Yes" and action type ""
  ...
  @UI-Cards
  Scenario: Bulk card change status
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get card number for which action applicable "Yes" and action type ""
