Feature: Country User : Fee Profile module scenarios

  Scenario: Country User : OMV-3462 Add public Fee profile of type 'Card fee'
  ...
  Scenario: Country User : Validate error message 'Fee profile name must be unique' with out pinning an account for fee type "Card fee"
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
  ...
  Scenario: Country User : OMV-3462 Add public Fee profile of type 'Account and Transaction fee'
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
  ...
  Scenario: Country User : Validate error message 'Fee profile name must be unique' with out pinning an account for fee type "Account and Transaction fee"
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
  ...
  Scenario: Country User : Add private Fee profile of type 'Card fee'
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
  ...
  Scenario: Country User : Add private Fee profile of type 'Account and Transaction fee'
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
  ...
  Scenario: Country User : Validate error message 'Fee profile name must be unique' after pinning an account for fee type "Card fee"
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
  ...
  Scenario: Country User : Validate error message 'Fee profile name must be unique' after pinning an account for fee type 'Account and Transaction fee'
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
  ...
  Scenario: Country User : Assign public card fee profile to a customer
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
...
#    And User validate the assigned "card" fee profile to a customer "commonAccountNo"
  ...
  @Test
  Scenario: Country User : Assign public account fee profile to a customer
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    And User select client and country based on logged in user "CountryUserName"
