Feature: UI:CountryUser - Financial Information scenarios from Accounts module
    ###################### Financial information section validation ########################

  @UI-FinancialInformation
  Scenario: TC-01 : Country User : OMV-1064 Validate edit functionality of Dunning DETAILS section in 'Financial information' module
  ...
  @UI-FinancialInformation
  Scenario: TC-01 : Country User : OMV-1403 : Validate user must be able to view financial account related information in the account details for country user
    Given User is on Login page and validate WEX logo text "OMV", for scenario "<Scenario>"
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User select "Select account" option using tag name "div" from context picker if logged in user "CountryUserName" has access to more than one customer
    And User select client and country based on logged in user "CountryUserName"
    And User enter account number in corresponding field which "has", "Active" status and "Active" based on logged in user "CountryUserName"
    And User click on "Search" button
    And User click three dot icon of "1" record in module "accounts" based on "accountName"
    Then User click on button "Select account"
...
############3
  @UI-FinancialInformation
  Scenario: TC-01 : Country User : OMV-1011 Validate edit functionality of account details section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  Scenario: TC-01 : Country User : OMV-1013 Validate edit functionality of Credit/Alerts Details section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  @UI-FinancialInformation
  Scenario: TC-01 : Country User : OMV-1012 Validate edit functionality of CARD BALANCE ALERTS section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  @UI-FinancialInformation
  Scenario: TC-01 : Country User : OMV-1017 Validate edit functionality of BANK DETAILS section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
    ...
    ##Done
  @UI-FinancialInformation
  Scenario: TC-01 : Country User : OMV-1018 Validate edit functionality of Security deposit section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  Scenario: TC-01 : Country User : OMV-1014 Validate edit functionality of Billing DETAILS section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  @UI-FinancialInformation
  Scenario: TC-01 : Country User : OMV-1000 Validate edit functionality of Security/Solvency DETAILS section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  @UI-FinancialInformation
  Scenario: TC-01 : Country User : OMV-1014 Validate edit functionality of Guarantee DETAILS section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  Scenario: TC-01 : Country User : OMV-1749 Validate view multiple bank account sections in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
  ...
  Scenario: TC-01 : Country User : OMV-1053 Validate edit functionality of GUARANTEES section in 'Financial information' module
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User get an account number based on status "" and substatus ""
  ...
  Scenario: TC01: Country User :OMV-2030 Validate Decline flow on the processing date for Billing details section
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
  ...
  Scenario: TC03:  Country User :OMV-2030 Validate Approve flow on the system date for Billing details section
    Given User is on Login page and validate WEX logo text "OMV", for scenario ""
    And User click on button "Home" using span text
    And User make sure account is not pinned for logged in user
    Then User select "Select account" option using tag name "div" from context picker if logged in user "<UserName>" has access to more than one customer
