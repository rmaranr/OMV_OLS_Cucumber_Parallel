Feature: UI:CountryUser - Group PIN Scenarios from Cards module


    #Groupd pin module for cards
  @UI-GroupPin
  Scenario: OMV-894 : Validate Search and Default field values in Group PIN module after pinning an account for Country User
